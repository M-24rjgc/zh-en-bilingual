...
模型在非英语上的表现会差一点，这是有数据的。Anthropic 的多语言测评里英文是 100% 基准，简体中文约是它的 96.9%（Haiku 4.5 只有 94.2%），差距主要来自训练语料里英文占多数（[arXiv:2404.11553](https://arxiv.org/abs/2404.11553)；GPT-4 技术报告也提到翻译会丢细微信息）。所以对格式要求严的提示词，用英文通常更稳。这不是说中文会"降智"，日常聊天、中文写作用中文完全没问题。
